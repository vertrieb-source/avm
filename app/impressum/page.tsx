        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <br>Sie haben das Recht, binnen 14 Tagen ohne Angabe von Gründen diesen Vertrag zu widerrufen. Die Widerrufsfrist beträgt 14 Tage ab dem Tag des Vertragsabschlusses (d. h. sobald Sie den Auftrag zur Fahrzeugvermittlung erteilt haben). 
              ...
              Sie können dafür das Muster-Widerrufsformular verwenden, das jedoch nicht vorgeschrieben ist.</br>


              <strong>Folgen des Widerrufs</strong>
              <br>Wenn Sie diesen Vertrag widerrufen, haben wir alle Zahlungen, die wir von Ihnen erhalten haben, unverzüglich und spätestens binnen 14 Tagen ab dem Tag zurückzuzahlen, an dem die Mitteilung über Ihren Widerruf eingegangen ist.</br>
              <strong>Besondere Hinweise:</strong>
              <br>Sie haben ausdrücklich zugestimmt, dass AVM vor Ablauf der Widerrufsfrist mit der Vermittlung beginnt. Dadurch erlischt Ihr Widerrufsrecht bei vollständiger Erfüllung unserer Dienstleistung, d. h. sobald AVM erfolgreich einen Käufer für Ihr Fahrzeug vermittelt hat.
              Sie zahlen im Erfolgsfall die vereinbarte Provision von 5 % des Verkaufspreises.</br>
